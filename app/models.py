...
class TeamSttConfig(Base):
    ...
    setup_status: Mapped[SttConfigSetupStatus] = mapped_column(String(64), default=SttConfigSetupStatus.ready, server_default=SttConfigSetupStatus.ready.value, nullable=False)
    is_active: Mapped[bool] = mapped_column(default=True, nullable=False)
