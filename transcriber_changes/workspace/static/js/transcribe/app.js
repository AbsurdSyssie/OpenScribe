import { attachTranscribeActions } from './actions.js?v=20260718-prototype-csrf-import';
...
import { createAudioCaptureController } from './media.js?v=20260718-prototype-csrf-import';
...
import { csrfFetch } from '/static/js/csrf.js';
    ...
    activeStatusPill.addEventListener('keydown', (event) => {
      ...
      const sidebarSessionGroup = (value) => {
        ...
        return {
          ...
          period: date.getUTCHours() < 12 ? 'morning' : 'afternoon',
        };
      };
