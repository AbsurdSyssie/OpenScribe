...
def test_user_transcribe_page_shows_workspace_shell(client, make_team, make_user):
    ...
    assert 'src="/static/js/transcribe/app.js?v=20260524-working-note-clear-token"' in page.text
...
def test_transcribe_reorder_blocks_blank_note_lines():
    ...
    assert "/static/js/transcribe/app.js?v=20260524-working-note-clear-token" in shell_extras
