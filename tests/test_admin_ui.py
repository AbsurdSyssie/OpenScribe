...
def test_user_transcribe_page_shows_workspace_shell(client, make_team, make_user):
    ...
    assert 'src="/static/js/transcribe/app.js?v=20260521-working-note-enqueue-hardening"' in page.text
...
def test_transcribe_reorder_blocks_blank_note_lines():
    ...
    assert "/static/js/transcribe/app.js?v=20260521-working-note-enqueue-hardening" in shell_extras
...
def test_transcribe_frontend_uses_global_template_selector_for_generation_controls():
    ...
    assert "if (noteGenerationInFlight) return noteGenerationInFlight;" in app_js
