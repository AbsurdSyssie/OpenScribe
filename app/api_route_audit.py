...
ALL_AUDIT_CASES: tuple[AuditCase, ...] = (
    ...
    AuditCase("GET", "/api/v1/hallucination-check-selection", AccessTier.system_admin),
    AuditCase(
        "POST",
        "/api/v1/hallucination-check-selection",
        AccessTier.system_admin,
        json_body=_json(team_id=PLACEHOLDER_UUID, llm_config_id=PLACEHOLDER_UUID, model_name_override="llama3.2"),
    ),
    AuditCase("DELETE", "/api/v1/hallucination-check-selection", AccessTier.system_admin),
    ...
    AuditCase(
        ...
        AccessTier.full,
        json_body=_json(quick_action_ids=[PLACEHOLDER_UUID]),
    ),
    AuditCase(
        "POST",
        ...
        AccessTier.full,
        form_data=_json(destination="personal"),
        files={"bundle": ("quick-actions.json", b'{"format":"openscribe-quick-action-bundle","format_version":1,"quick_actions":[]}', "application/json")},
    ),
    AuditCase(
        "POST",
    ...
    AuditCase(
        ...
        AccessTier.full,
        json_body=_json(smart_phrase_ids=[PLACEHOLDER_UUID]),
    ),
    AuditCase(
        "POST",
        "/api/v1/smart-phrases/import/preflight",
        AccessTier.full,
        files={"bundle": ("smart-phrases.json", b'{"format":"openscribe-smart-phrase-bundle","format_version":1,"smart_phrases":[]}', "application/json")},
    ),
    AuditCase(
        "POST",
        "/api/v1/smart-phrases/import",
        AccessTier.full,
        form_data=_json(selected_indexes="[0]"),
        files={"bundle": ("smart-phrases.json", b'{"format":"openscribe-smart-phrase-bundle","format_version":1,"smart_phrases":[]}', "application/json")},
    ),
