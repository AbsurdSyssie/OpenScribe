...
- The public schema and copied prompt provide the exact canonical label for each structured EMIS key; custom wording belongs in the section instruction rather than `section_label`.
